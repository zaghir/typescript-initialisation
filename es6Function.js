...
/*
* on a ajouter une valeur par defaut = 10 au parametere de la mothode
...
console.log.apply(console, ["...numbers ==> "].concat(numbers));
...
// le premier prametre est le nom , puis avec la fonction rest ==> ...{Var} on crée un tableau
